...
client.on('guildMemberAdd', member=> {
    member.addRole(member.guild.roles.find("name","!DRB Online"));
    });
...
client.on('guildMemberAdd', Sal => { //By Salto7#4595
    ...
    .setImage('https://cdn.discordapp.com/attachments/510567309702594564/510739066501988355/6a39e35882b236f29965c9070bad5ce51f1dd01f_hq-1-1-1-1-1.gif') //هنا حط الصوره الي تبيها
    .setTitle('عضو جديد!')
